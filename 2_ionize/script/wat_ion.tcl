...
autoionize -psf A1A6_ws.psf -pdb A1A6_ws.pdb -is 0.308 -o A1A6_ion -seg IO1

[atomselect top all] set beta 0
[atomselect top protein] set beta 1
[atomselect top all] writepdb protein.fix

[atomselect top all] set beta 0
[atomselect top backbone] set beta 1
[atomselect top all] writepdb backbone.fix
