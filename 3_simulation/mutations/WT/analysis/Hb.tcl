...
##############���ڼ���Occupancy��ֵ�ı���
  ...
  for { set i 0 } { $i < $numberofframes } { incr i } {
      ...
      for { set j 0 } { $j < [llength [lindex $hbondsingleframe 0] ] } { incr j } {
          ...
          #lappend newhbond [lindex $hbondsingleframe 2 $j ]  #���δ��пɽ�����������ͬ����ԭ�Ӳ�ͬ���������ͬһ�������ͬʱҲ���ε�����ԭ�ӵ���Ϣ
	...
	# ��hbondsingleframe1�е�ֵ���ϵ�$hbondallframes��
...
########################################################################
set A6 [atomselect top "chain A"]
set Sp [atomselect top "backbone"]
hbond_occupancy_5 3.5 30 $A6 $Sp Hbond_pcv5-3_A6S.dat
