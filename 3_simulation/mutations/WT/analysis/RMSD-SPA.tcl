...
set outfile [open RMSD-SPA.dat w];                                             
set nf [molinfo top get numframes]
set frame0 [atomselect top "protein and backbone and noh" frame 0]
set sel [atomselect top "protein and backbone and noh"]
set body0 [atomselect top "segname SPA and backbone and noh" frame 0]
set body [atomselect top "segname SPA and backbone and noh"]
